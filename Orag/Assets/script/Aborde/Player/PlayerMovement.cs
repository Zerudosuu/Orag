...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private Transform playerSprite;// para sa pag flip sprite
    [SerializeField] private LayerMask groundLayer;
    [SerializeField] private Animator animator;
    [SerializeField] private TextMeshProUGUI playerState_Text;
    ...
    private void Update()
    {
        ...
        playerState_Text.text = playerState.ToString();
    }
    ...
    void KeyboardControls()
    {
        ...
        // shift - dash
        if (Input.GetKeyDown(dashKey) & allow_Dash)
        {
